...
<body>
 ...
 //post                       <form action="enviar.php" method="post">
                            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                    <div class="order-details-confirmation">
                        ...
                        <input type="sumit" value="enviar mensaje" id="btsend">
                     <a href="enviar.php"   class="btn essence-btn" type="sumit">Place Order</a>
                    </div>
                </div>
            </div>
        </div>
