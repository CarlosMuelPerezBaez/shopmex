...
<body>
    ...
    <?php 
        ...
        $resArticulos=$sentence->fetchAll(PDO::FETCH_OBJ);
    ...
    <section class="new_arrivals_area section-padding-80 clearfix">
        ...
        <div class="container">
            <div class="row">
                ...
                <?php foreach($resArticulos as $articulo): ?>
                        <!-- Single Product -->
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src=" <?php echo 'img/product-img/product-'.($articulo->id_producto-1).'.jpg'; ?> " alt="">
