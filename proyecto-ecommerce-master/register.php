...
<head>
  ...
  <title>ShopMex | Registrarse</title>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">¡Registrate y descubre la cultura Mexicana!</p>

    <form action="member_regist.php" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="nombreC" placeholder="Nombre Completo">
      ...
      <div class="form-group has-feedback">
        ...
        <span class="glyphicon glyphicon glyphicon-pushpin form-control-feedback"></span>
      </div>
       <div class="form-group has-feedback">
        <select name="pais" class="form-control" id="register_pais">
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox"> Estoy de acuerdo con los  <a href="#" data-toggle="modal" data-target="#modalPoliticas" >terminos y condiciones</a>
            </label>
          </div>
        </div>
        <!-- /.col -->
