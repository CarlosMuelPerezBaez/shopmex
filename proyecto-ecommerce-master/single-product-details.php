                ...
                <div class="cart-fav-box d-flex align-items-center">
                    ...
                    <?php 
                        ...
                        if(!isset($_SESSION["usuario"])){
                            echo '<button type="submit" name="addtocart" value="5" style="background:#33829A;" class="btn essence-btn">Debes de Iniciar sesion para añadir al carrito</button>';
                        }else
                        {
                            echo '<button type="submit" name="addtocart" value="5" class="btn essence-btn">Agregar al Carrito de Compra</button>';
                        }
